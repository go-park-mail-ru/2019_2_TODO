...
// func (tk *JwtToken) Create(s *securecookie.SecureCookie, tokenExpTime int64) (string, error) {
...
// func (tk *JwtToken) Check(s *securecookie.SecureCookie, inputToken string) (bool, error) {
...
// 	}
// 	return payload.SessionID == s.hashKey && payload.UserID == s.UserID, nil
// }
